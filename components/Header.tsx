        ...
        <AnimatePresence>
          {scrolled && (
            <motion.nav
              ...
              className="backdrop-blur-md bg-black/40 rounded-xl px-4 sm:px-8 py-3 flex items-center justify-between gap-8 border border-white/10 shadow-2xl shadow-black/50 w-full max-w-2xl pointer-events-auto"
            >
