      ...
      <div className="pt-8 columns-1 md:columns-2 lg:columns-3 gap-8 space-y-8">
        {siteData.projects.map((project, index) => (
          <motion.div
            ...
            className="break-inside-avoid group relative rounded-xl overflow-hidden glass border-border hover:border-white/20 transition-all duration-500 flex flex-col h-full"
          >
            {project.image && (
            ...
            <div className="p-8 space-y-6 flex flex-col flex-grow">
              ...
              <div className="flex flex-wrap gap-2">
                {project.tech.map((t) => (
                  <span
                    key={t}
                    className="text-xs font-mono px-3 py-1 rounded-xl bg-white/5 border border-white/10"
                  >
                    {t}
                  </span>
                ))}
